...
const FilterProperty: FC<FilterPropertyProps> = ({ setListProperty }) => {
    ...
    const [isChecked, setIsChecked] = useState(localStorage.getItem("isAiChecked"));
        ...
        >
            ...
            {isChecked ?
                <>
                    ...
                    <Button colorScheme="blue" size="lg" type="submit" onClick={() => { fetchPropertyWithAI(params.get('prompt')) }}>
                        Cari properti
                    </Button>
                </>
                :
